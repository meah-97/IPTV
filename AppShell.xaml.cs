...
public partial class AppShell : Shell
{
    public AppShell()
    {
        ...
        Routing.RegisterRoute(nameof(Pages.LocalDownloadsPage), typeof(Pages.LocalDownloadsPage));
        Routing.RegisterRoute(nameof(Pages.DownloadsPage), typeof(Pages.DownloadsPage));
    }
}
